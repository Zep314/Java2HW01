...
/* Вывод программы:
Продукт найден: Наименование:Кофе, Цена: 80.0, Температура напитка: 80, Объем напитка: 0.2
Такого продукта нет в этом вендинговом автомате!
Продукт найден: Наименование:Какао, Цена: 50.0, Температура напитка: 65, Объем напитка: 0.25
 */